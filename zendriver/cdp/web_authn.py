...
class VirtualAuthenticatorOptions:
    ...
    def from_json(cls, json: T_JSON_DICT) -> VirtualAuthenticatorOptions:
        return cls(
            ...
            has_hmac_secret=bool(json["hasHmacSecret"])
            if json.get("hasHmacSecret", None) is not None
            else None,
            has_hmac_secret_mc=bool(json["hasHmacSecretMc"])
            if json.get("hasHmacSecretMc", None) is not None
            else None,
