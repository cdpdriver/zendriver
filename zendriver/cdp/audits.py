...
class InspectorIssueDetails:
    ...
    def from_json(cls, json: T_JSON_DICT) -> InspectorIssueDetails:
        return cls(
            ...
            connection_allowlist_issue_details=ConnectionAllowlistIssueDetails.from_json(
                json["connectionAllowlistIssueDetails"]
            )
            if json.get("connectionAllowlistIssueDetails", None) is not None
            else None,
            ...
            performance_issue_details=PerformanceIssueDetails.from_json(
                json["performanceIssueDetails"]
            )
            if json.get("performanceIssueDetails", None) is not None
            else None,
            selective_permissions_intervention_issue_details=SelectivePermissionsInterventionIssueDetails.from_json(
                json["selectivePermissionsInterventionIssueDetails"]
            )
            if json.get("selectivePermissionsInterventionIssueDetails", None)
            is not None
            else None,
        )
