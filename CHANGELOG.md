...
- Docs: `core` modules included in documentation reference section. Slight modifications were done, mostly to remove warnings. Documentation navbar had some nested sections flattened out. @Kajmany
